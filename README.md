...
The goal of this week was to strengthen core concepts before moving into higher-level systems such as Nav2 and autonomous navigation.
...
- **Topics** enable asynchronous, continuous communication  
  (e.g., sensor data streams, velocity commands like `/cmd_vel`).

- **Services** implement synchronous request–response interactions  
  (e.g., triggering actions, requesting data).
...
### `my_first_pkg`
Contains basic control experiments:
- Simple publisher
- cmd_vel publisher
- Turn controller
- Wall stop logic
